...
void MOTOR_Init(void){  //pwm
    ...
    TIM_TimeBaseInitTypeDefStrue.TIM_Period=1000-1;
    TIM_TimeBaseInitTypeDefStrue.TIM_Prescaler=720-1;
    TIM_TimeBaseInitTypeDefStrue.TIM_ClockDivision=TIM_CKD_DIV1;
    TIM_TimeBaseInitTypeDefStrue.TIM_RepetitionCounter=0;
    ...
    TIM_OCInitTypeDefStrue.TIM_OCMode=TIM_OCMode_PWM1; //timx_cnt <timx_crrx -> 输出有效电平
    ...
    TIM_OC4Init(TIM4,&TIM_OCInitTypeDefStrue);
}
