...
void MOTOR_Init(void){  //pwm
    ...
    GPIO_InitTypeDefStrue.GPIO_Pin=GPIO_Pin_8|GPIO_Pin_9|GPIO_Pin_0|GPIO_Pin_1;
    ...
    TIM_OC3Init(TIM3,&TIM_OCInitTypeDefStrue);
    TIM_OC4Init(TIM3,&TIM_OCInitTypeDefStrue);
...
void MOTO_Control(u8 *temp){
        if(temp[0]=='1' && (u16)temp[1]=='1' && (u16)temp[2]=='1'){MOTOR_Forward(50);}
        else if(temp[0]=='0' && temp[1]=='1' && temp[2]=='1'){MOTOR_Back(50);}
        else if(temp[0]=='1' && temp[1]=='0' && temp[2]=='1'){MOTOR_Left(50);}
        else if(temp[0]=='1' && temp[1]=='1' && temp[2]=='0'){MOTOR_Right(50);}
        else{MOTOR_Stop();}
}
